...
export default function FilterBoard({ 
  ...
  const isFiltered = divisionFilter !== 'All' || levelFilter !== 'All';
      ...
      <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 w-full lg:w-auto flex-1">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto flex-1 lg:flex-none">
          ...
          <select 
            ...
            className="w-full sm:w-auto min-w-[200px] bg-white/60 border border-slate-200 rounded-xl px-3 py-2 text-slate-700 outline-none focus:border-brand-gold focus:ring-2 focus:ring-brand-gold/20 font-semibold text-xs cursor-pointer transition-all"
          >
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto flex-1 lg:flex-none">
          ...
          <select 
            ...
            className="w-full sm:w-auto min-w-[150px] bg-white/60 border border-slate-200 rounded-xl px-3 py-2 text-slate-700 outline-none focus:border-brand-gold focus:ring-2 focus:ring-brand-gold/20 font-semibold text-xs cursor-pointer transition-all"
          >
