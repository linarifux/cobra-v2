...
export default function Sidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed md:relative top-0 left-0 z-50 flex flex-col transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] h-[100dvh]",
          // Mobile: Always 64 wide, but slide on/off screen based on isOpen
          "w-64 md:w-auto",
          isOpen 
      ...
      >
        ...
        <div className="relative z-10 flex items-center h-20 px-4 border-b border-white/5 transition-all duration-300">
          <div className={cn(
            ...
            // Keep elements spread on mobile always, collapse only on desktop
            ...
            <span className={cn(
              ...
              // Stay visible on mobile, hide only on desktop when closed
              isOpen 
                ? "w-auto opacity-100 translate-x-0" 
                : "w-auto opacity-100 translate-x-0 md:w-0 md:opacity-0 md:-translate-x-8 md:hidden"
            )}>
                ...
                >
                  <Link
                    ...
                    className={cn(
                      ...
                      isOpen ? "px-4" : "px-4 md:justify-center md:px-0",
                      isActive 
                  ...
                  >
                    ...
                    <span className={cn(
                      ...
                      isOpen 
                        ...
                        : "ml-4 opacity-100 translate-x-0 md:w-0 md:opacity-0 md:-translate-x-6 md:hidden md:absolute"
                    )}>
                      {item.name}
                    </span>
                  </Link>
        ...
        <div className={cn(
          ...
          isOpen ? "flex items-center gap-4" : "flex items-center gap-4 md:justify-center"
        )}>
