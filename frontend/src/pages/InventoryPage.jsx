...
export default function InventoryPage() {
  ...
  const mappedInventory = useMemo(() => {
    ...
    return apiInventory.map(item => ({
      ...
      category: item.category1?.categoryName,
      categoryId: item.category1?._id || '',
      category2: item.category2?.categoryName,
      category2Id: item.category2?._id || '',
      category3: item.category3?.categoryName,
      category3Id: item.category3?._id || '',
      location: item.location?.locationName || 'Unassigned',
