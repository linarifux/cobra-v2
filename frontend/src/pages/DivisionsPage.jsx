                  ...
                  >
                    <td className="p-5">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center border border-slate-200 shrink-0 overflow-hidden p-1 shadow-sm">
                          {div.divisionLogo ? (
                             <img src={div.divisionLogo} alt={div.divisionName} className="w-full h-full object-contain" />
                          ) : (
